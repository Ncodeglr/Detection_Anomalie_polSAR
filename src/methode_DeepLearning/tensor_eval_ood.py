...
def evaluate_ood_system(model, loader1_train, loader1_valid, loader2_1, final_loaders_to_test, anomaly_definitions, pfa_target=0.05, device="cpu", out_dir=Path(".")):
    ...
    for i, (loader_part, anomaly_def) in enumerate(zip(final_loaders_to_test, anomaly_definitions)):
        zone_index = i // 2 + 1
        ...
        # Restore transform APRÈS la visualisation pour que le batch affiché contienne bien l'anomalie
